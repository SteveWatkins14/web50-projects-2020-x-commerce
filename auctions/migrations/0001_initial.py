    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', enumfields.fields.EnumField(blank=True, enum=auctions.models.Category, max_length=6, null=True)),
                ('created', models.DateTimeField(auto_now_add=True)),
                ...
                ('winning_bid', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='item', to='auctions.bid')),
            ],
        ),
        migrations.CreateModel(
            name='Watchlist',

    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(blank=True, choices=[('Beauty', 'Beauty'), ('Books', 'Books'), ('CDs', 'Cds'), ('Clothing', 'Clothing'), ('Computers', 'Computers'), ('Home & Kitchen', 'Home And Kitchen'), ('Shoes & Bags', 'Shoes And Bags'), ('Toys & Games', 'Toys And Games')], max_length=14, null=True)),
